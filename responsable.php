  ...
  <body>
    <header>
      <div class="responsible-block">
        <div class="container">
          <div class="age-num">18+</div>
          <p>
            Nous vous encourageons à jouer de manière responsable. Vous pouvez
            trouver des lignes directrices sur
            <a href="https://casinosenlignepro.com/responsible.php"
              >notre page</a
            >
          </p>
        </div>
    ...
    <main class="styled-section">
      ...
      <p>
        <strong>Données liées aux commentaires</strong><br />
        Lors de la soumission d’un commentaire sur notre site, nous collectons
        les informations que vous fournissez dans le formulaire, ainsi que votre
        adresse IP et certaines données techniques de votre navigateur. Ces
        mesures sont mises en place pour assurer la sécurité et prévenir les
        abus.
      </p>

      <p>
        Une interface attrayante ne garantit pas toujours la fiabilité :
        certains sites peuvent dissimuler des pratiques peu scrupuleuses ou non
        conformes. Nous mettons la transparence et la conformité au cœur de
        notre engagement.
      </p>

      <p>
        Naviguez en toute confiance grâce à nos recommandations, fondées sur une
        évaluation rigoureuse de plateformes respectant strictement les normes
        légales en vigueur.
      </p>
    </main>
      ...
      <div class="container">
        ...
        <div class="footer-info">
          ...
          <div class="footer-respons">
            <div class="age-red"><p>18+</p></div>
            <div class="age-text"><p>Conditions générales en vigueur.</p></div>
          </div>
        </div>
        <div class="footer-menu">
          ...
          <div class="coop"><p>Nouveaux Casinos - 2025 © 2025</p></div>
        </div>
      </div>
    </footer>
    ...
    <div id="cookie-consent">
      <div class="cookie-popup">
        ...
        <div class="cookie-buttons">
          ...
          <button id="reject-cookies">Refuser tout</button>
        </div>
      </div>
    </div>
    ...
    <div class="contact-overlay" id="contactModal">
      <div class="contact-modal-content">
        ...
        <button id="closeContactModal" style="margin-top: 1rem">Fermer</button>
      </div>
    </div>
    ...
    <script>
      document.addEventListener("DOMContentLoaded", () => {
        ...
        contactLink.addEventListener("click", (e) => {
          e.preventDefault(); // відміняємо поведінку посилання
        ...
        // Додатково: закриття модалки при кліку поза нею
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        ...
        // Показати банер, якщо ще немає збереженого рішення
