...
<html lang="en">
  ...
  <body>
    ...
    <main class="styled-section">
      ...
      <p>
        <strong>Données des commentaires</strong><br />
        Lorsque vous laissez un commentaire sur notre site, nous collectons les
        informations que vous saisissez, ainsi que votre adresse IP et certains
        paramètres techniques de votre navigateur. Ces données sont utilisées
        pour assurer la sécurité et prévenir les abus.
      </p>

      <p>
        Méfiez-vous des sites qui cachent des pratiques douteuses derrière une
        interface soignée. Ce n’est pas notre approche : la transparence est
        notre priorité.
      </p>

      <p>
        Profitez d’un jeu sécurisé avec notre sélection de plateformes fiables,
        rigoureusement contrôlées et conformes à toutes les exigences légales.
      </p>
    </main>
